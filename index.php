        ...
        <div class="container-fluid bg-primary">
            <div class="card text-bg-dark">
                ...
                <div class="card-img-overlay">
                    ...
                    <p style="color: dark;"><h4>Join our community of compassionate individuals dedicated to ensuring transparent donations. With our platform, you can effortlessly manage your donations, support causes you care about, and track your impact in real-time.Together, we can create
                        positive change and leave a lasting impact on the world.</h4></p>                    
                    </button>
                </div>
            </div>
        </div>
